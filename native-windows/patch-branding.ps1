...
# Splash: no legacy product/solver identity shown at startup.
Replace-IfPresent 'PrePoMax/Forms/FrmSplash.Designer.cs' 'this.labProgramName.Text = "PrePoMax v0.0.0.0";' 'this.labProgramName.Text = "AsterMax Mechanical";'
Replace-IfPresent 'PrePoMax/Forms/FrmSplash.Designer.cs' 'this.labHelp.Text = "PrePoMax is a graphical pre and post-processor for the free CalculiX FEM solver o" +`r`n    "n Windows platform.";' 'this.labHelp.Text = "AsterMax Mechanical — native CAE pre/post environment for Code_Aster workflows.";'
Replace-IfPresent 'PrePoMax/Forms/FrmSplash.Designer.cs' 'this.panel1.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("panel1.BackgroundImage")));' 'this.panel1.BackgroundImage = null; this.panel1.BackColor = System.Drawing.Color.FromArgb(0,102,204);'
Replace-IfPresent 'PrePoMax/Forms/FrmSplash.Designer.cs' 'this.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("$this.BackgroundImage")));' 'this.BackgroundImage = null;'

# Advisor/help strings that are visible in normal workflows.
...
# Replace only quoted/user-visible product labels and filters, never namespace declarations.
...
# Home page should not send a user to the legacy product site.
