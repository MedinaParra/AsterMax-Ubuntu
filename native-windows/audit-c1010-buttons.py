...
<li>Prueba Windows: inventario de botones con delegado e imagen, capturas por pestaña, árbol/cinta sin superposición, importación STEP y mallado reales. No ejecuta automáticamente comandos de edición o borrado. El detalle de esta ejecución está en Validation/C10.10/*.buttons.json.</li>
