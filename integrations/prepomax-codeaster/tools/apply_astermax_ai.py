...
def main():
    ...
    for name in ["AsterMaxAiChatForm.cs", "AsterMaxAiIntegration.cs", "AsterMaxUiTheme.cs", "AsterMaxWorkflowStrip.cs"]:
    ...
    print("patched", frm)
    print("AsterMax AI + professional workflow UI integration applied successfully.")
    return 0
