...
def main():
    ...
    for name in ["AsterMaxAiChatForm.cs", "AsterMaxAiIntegration.cs", "AsterMaxUiTheme.cs", "AsterMaxWorkflowStrip.cs", "AsterMaxEngineeringTree.cs"]:
    ...
    print("patched", frm)
    print("AsterMax AI + workflow + engineering model tree integration applied successfully.")
    return 0
