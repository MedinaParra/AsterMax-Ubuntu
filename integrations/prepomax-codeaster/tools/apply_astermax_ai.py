...
def main():
    ...
    names=["AsterMaxAiChatForm.cs","AsterMaxAiIntegration.cs","AsterMaxUiTheme.cs","AsterMaxWorkflowStrip.cs","AsterMaxViewportHud.cs","AsterMaxGlyphLayer.cs","AsterMaxGlyphIntegration.cs","AsterMaxModelReadiness.cs","AsterMaxReadinessIntegration.cs","AsterMaxRegionBindingInspector.cs","AsterMaxRegionBindingIntegration.cs","AsterMaxNativeVtkAnchorLayer.cs","AsterMaxNativeVtkAnchorIntegration.cs","AsterMaxPmxRoundtripHarness.cs","AsterMaxNativeRefinementPersistenceHarness.cs","AsterMaxStepMmHarness.cs","AsterMaxStepMeshHarness.cs","AsterMaxStructuralSetupHarness.cs","AsterMaxCodeAsterGenerationHarness.cs","AsterMaxEngineeringTree.cs","AsterMaxResultsWorkspace.cs"]
    ...
    print("AsterMax C8.88 native FeMeshRefinement PMX persistence gate and prior CAD/mesh/results integration applied successfully."); return 0
