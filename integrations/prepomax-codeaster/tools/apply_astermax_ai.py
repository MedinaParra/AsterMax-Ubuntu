...
def main():
    ...
    names=["AsterMaxAiChatForm.cs","AsterMaxAiIntegration.cs","AsterMaxUiTheme.cs","AsterMaxWorkflowStrip.cs","AsterMaxViewportHud.cs","AsterMaxGlyphLayer.cs","AsterMaxGlyphIntegration.cs","AsterMaxModelReadiness.cs","AsterMaxReadinessIntegration.cs","AsterMaxRegionBindingInspector.cs","AsterMaxRegionBindingIntegration.cs","AsterMaxNativeVtkAnchorLayer.cs","AsterMaxNativeVtkAnchorIntegration.cs","AsterMaxPmxRoundtripHarness.cs","AsterMaxNativeRefinementPersistenceHarness.cs","AsterMaxNativeRoiConsumerHarness.cs","AsterMaxStepMmHarness.cs","AsterMaxStepMeshHarness.cs","AsterMaxStructuralSetupHarness.cs","AsterMaxCodeAsterGenerationHarness.cs","AsterMaxEngineeringTree.cs","AsterMaxResultsWorkspace.cs"]
