...
def measure_curved_shoulder_geometry_error(
    ...
    *,
    ...
    """Regenerate Gmsh CAD-projected TET10 and audit its fillet surface nodes."""
    ...
    try:
        ...
        payload = {
            "schema": "AsterMaxCurvedShoulderGeometryEvidenceV1",
            ...
            "method": "OCC_CLOSEST_POINT_DISTANCE_OF_CAD_PROJECTED_TRI6_NODES_ON_IDENTIFIED_FILLET_SURFACE",
        }
